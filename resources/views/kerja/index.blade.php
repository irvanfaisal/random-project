@extends('master', ['title' => "Kerja apa?", 'url' => "http://localhost/goblog/public/kerjaapa"])
...
@section('content')
    ...
    <div class="container">
        <h2><b>Sekarang kerja apa?</b></h2>
        <h3>{{ $answers->answer }}</h3>
        <br/>
        <a class="btn-lg btn-info" href="{{ url('',['kerjaapa']) }}"><b>Nanya lagi?</b></a>
        <br/>
        <br/>
        <br/>
